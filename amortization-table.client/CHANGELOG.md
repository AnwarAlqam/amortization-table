...
- Create Angular project with ng: `ng new amortization-table.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`amortization-table.client.esproj`).
